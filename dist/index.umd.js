(function (global, factory) {
  ...
  (global = global || self, factory(global.ReactIoC = {}, global.React));
  ...
  const Provider = (name) => {
      ...
      return (Cmpt) => {
          return class Regist extends React.Component {
              constructor() {
                  super(...arguments);
                  this.state = {
                      context: {},
              ...
              render() {
                  return (React__default.createElement(Context.Provider, { value: this.state.context },
                      React__default.createElement(Cmpt, Object.assign({}, this.props))));
              }
          };
      };
  };
          ...
          return class Instance extends React.Component {
              constructor() {
                  ...
                  this.renderContext = (context) => {
                      ...
                      return React__default.createElement(Cmpt, Object.assign({}, props));
                  };
              }
              render() {
